<template>
    <div>
      <el-container>
        <el-header style="height: 40px"><i @click="$router.back()"  class="el-icon-arrow-left"/>准客户资料</el-header>
        <el-main>
          ...
          <div style="background-color: #ccc ">
            <el-button style="margin-left: 70px;margin-top: 10px;margin-bottom: 10px" icon="el-icon-edit" @click="$router.push({ name: 'UpdateSCClint', query: {id: item.cid }})" type="primary">编辑</el-button>
            <el-button  @click="deleteClint(item.cid)" icon="el-icon-delete" type="danger">删除</el-button>
          </div>
        </el-main>
      </el-container>
    </div>
